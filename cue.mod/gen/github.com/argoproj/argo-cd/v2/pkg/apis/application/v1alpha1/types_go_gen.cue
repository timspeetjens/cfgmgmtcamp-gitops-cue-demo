...
#ApplicationSource: {
	...
	ksonnet?: null | #ApplicationSourceKsonnet @go(Ksonnet,*ApplicationSourceKsonnet) @protobuf(9,bytes,opt)
...
#ApplicationSourceKsonnet: {
	...
	environment?: string @go(Environment) @protobuf(1,bytes,opt)

	// Parameters are a list of ksonnet component parameter override values
	parameters?: [...#KsonnetParameter] @go(Parameters,[]KsonnetParameter) @protobuf(2,bytes,opt)
}
